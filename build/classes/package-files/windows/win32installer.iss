...
AppCopyright=Copyright © 1998-2017 Contributors
AppID=jEdit
AppName=jEdit
...
InfoBeforeFile=C:\Users\User\Downloads\jedit_merge\dist\doc\COPYING.txt
OutputBaseFilename=jedit5.2pre1install
OutputDir=C:\Users\User\Downloads\jedit_merge\dist
SetupIconFile=C:\Users\User\Downloads\jedit_merge\icons\jedit.ico
ShowTasksTreeLines=true
SolidCompression=true
SourceDir=C:\Users\User\Downloads\jedit_merge\dist
TimeStampsInUTC=true
UninstallDisplayIcon={app}\jedit.exe
UninstallDisplayName=jEdit 5.2pre1
VersionInfoCompany=Contributors
VersionInfoCopyright=Copyright © 1998-2017 Contributors
VersionInfoDescription=Programmer's Text Editor
VersionInfoTextVersion=5.2pre1
VersionInfoVersion=05.02.01.00
WizardImageFile=C:\Users\User\Downloads\jedit_merge\icons\WindowsInstallerImage.bmp
WizardSmallImageFile=C:\Users\User\Downloads\jedit_merge\icons\WindowsInstallerSmallImage.bmp
...
[Files]
Source: jedit.jar; DestDir: {app}; Flags: ignoreversion sortfilesbyextension sortfilesbyname; Components: main
...
begin
	case SuppressibleMsgBox(CustomMessage('pleaseQuitJEdit'),mbConfirmation,MB_OKCANCEL or MB_DEFBUTTON2, IDYES) of
		IDOK: begin
			ExtractTemporaryFile('jedit.jar');
